### このゲームについて
　このゲームは大学2年の時にグループワークで作成したシューティングゲームです。使用している言語はpythonでpygameを用いてのゲーム作成となっています。
初めての共同制作という形でのゲーム作りであったため、コード等はかなり拙くなっています。ご了承ください。
　以下に当時製作したReadmeを記載しておきます。


### ゲーム概要
-  どこかのマスコットキャラである鳥が宇宙からやってきた敵から身を守るため、
